...
const Select = ({ options, id, classStyle, value, disabled, funcaoOnChange, placeHolder, required = true, defaultOption = "Selecione" }: SelectType) => {
    ...
    return (
        <div className='flex flex-col w-full'>
            <select
                className={`bg-amarelo-200 shadow-sm w-full rounded-[10px] text-base p-3 box-border text-verde-600 disabled:bg-cinza-500 placeholder-verde-600 placeholder-opacity-100 ${classStyle}`}
                id={id}
