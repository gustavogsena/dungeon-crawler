...
function InventoryEquipments() {
    const navigate = useNavigate()
    const navigateToHeroPage = () => {
        navigate('/')
    }
    return (
        <div className='bg-black h-full md:w-2/4 min-w-[500px] rounded-lg bg-opacity-75 justify-center flex flex-wrap py-6'>
...
export default InventoryEquipments